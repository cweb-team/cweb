<%@ page contentType="text/html;charset=UTF-8" language="java" %>
                    ...
                    <div id="groupTeam-container">
                        ...
                        <div class ="group-table-page">
                            <ul>
                                <li v-if="currentPage>1"><span v-on:click="currentPage--,pageClick()" > < </span></li>
                                <li v-if="currentPage == 1"><span class="banClick"> < </span></li>
                                <li v-for="item in allPageComputed"  v-bind:class="{ 'active': currentPage == item}">
                                    <span v-on:click="btnClick(item)">{{ item }}</span>
                                </li>
                                <li v-if="currentPage != allPage"><span v-on:click="currentPage++,pageClick()" > > </span></li>
                                <li v-if="currentPage == allPage"><span class="banClick"> > </span></li>
